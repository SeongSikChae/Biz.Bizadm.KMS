namespace Biz.Bizadm.KMS.Protect.Cipher
{
    ...
    public sealed class WindowsCredentialManagerKekCredentialProvider : CredentialStoreKekCredentialProvider
    {
        ...
        /// <summary>
        /// Windows Credential Manager 제공자를 생성한다.
        /// </summary>
        ...
        /// <exception cref="PlatformNotSupportedException">Windows가 아닐 때.</exception>
        public static WindowsCredentialManagerKekCredentialProvider Create(
            ...
            string? @namespace = OsKekCredentialDefaults.Namespace)
        {
            ...
            {
                throw new PlatformNotSupportedException("WindowsCredentialManagerKekCredentialProvider requires Windows.");
            }
